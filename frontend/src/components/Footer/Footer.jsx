...
function Footer() {
  ...
  const cerrarModal = (e) => {
    // Para cerrarlo si clica fuera, yo prefiero solo en la x pero dime tu que prefieres
  ...
  return (
    <>
      <footer className="footer">
        ...
        <div className="links footer__social-links">
          {/* <!-- X (Twitter) --> */}
          <Link to="#">
            <svg
              fill="white"
              ...
              className="icons-social-media footer__social-icon instagram"
            >
          ...
          <Link to="#" target="_blank">
            <svg
              className="icons-social-media footer__social-icon x"
              fill="white"
          ...
          <Link to="#">
            <svg
              ...
              viewBox="0 0 448 512"
              xmlns="http://www.w3.org/2000/svg"
              className="icons-social-media footer__social-icon linkedin"
            >
          ...
          <Link to="#">
            <svg
              ...
              viewBox="0 0 496 512"
              xmlns="http://www.w3.org/2000/svg"
              className="icons-social-media footer__social-icon github"
            >
        ...
        <figure className="footer__logos">
          <img className="footer__logo-image" src="/img/LogoAgora.png" alt="Logo" />
          <img className="footer__logo-image" src="/img/UE.png" alt="Unión Europea" />
          <img className="footer__logo-image" src="/img/GobEspa.png" alt="Gobierno de España" />
        </figure>
      </footer>

      {/* MODAL DE PRIVACIDAD*/}
      {modalAbierto && (
        <div className="modal footer__modal" onClick={cerrarModal}>
          <div className="modal-contenido footer__modal-content">
            <span className="cerrar footer__modal-close" onClick={() => setModalAbierto(false)}>
              &times;
            </span>
