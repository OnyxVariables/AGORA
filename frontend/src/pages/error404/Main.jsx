    ...
    <main className="mainError">
      ...
      <section className="error">
        <article className="errorMessage">
          ...
          <h3>Mejor vuelve al inicio y sigue votando con blockchain, sin trampas y sin papeletas perdidas.</h3>
          <Link to="/">Ir a la página de inicio</Link>
        </article>
        <article className="errorImg">
          <picture><img src="/img/error404.png" alt="Blockchain"/></picture>
        </article>
      </section>
    </main>
  );
